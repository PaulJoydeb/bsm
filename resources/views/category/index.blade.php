                    ...
                    <div class="card-body">
                        <form action="{{ route('store.category') }}" method="POST">
                            ...
                            <div class="form-outline mb-4">
                                <textarea class="form-control" id="form6Example" rows="4" name="description"></textarea>
                                <label class="form-label" for="form6Example3">Additional Description/About</label>
                            </div>

                            <!-- Submit button -->
                            <button type="submit" class="btn btn-primary btn-block mb-4">Save Category</button>
                        </form>
                    </div>
                </div>
            </div>
